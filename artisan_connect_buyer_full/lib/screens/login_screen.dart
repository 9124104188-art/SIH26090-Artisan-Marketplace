...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final _emailController =
      TextEditingController(text: 'artisan@artisanconnect.org');
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      if (!mounted) return;
      ArtisanController().switchRole(user['role'] as String? ?? _selectedRole);
                  ...
                  child: TextButton(
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(
                              'Password reset link sent to your registered phone/email'),
                        ),
                      );
                    },
