                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              isArtisan
                                  ? 'Current: Artisan Dashboard'
                                  : 'Current: Buyer Marketplace',
                              style: const TextStyle(
                            ...
                            Text(
                              isArtisan
                                  ? 'Tap to view Marketplace'
                                  : 'Tap to access Artisan Cataloging',
                              style: const TextStyle(
                      ...
                      TextButton(
                        ...
                        child:
                            Text(isArtisan ? 'Switch Buyer' : 'Switch Artisan'),
                      ),
                    ],
                  ),
                ),
    ...
    VoidCallback? onTap,
      ...
      Container(
        ...
        child: ListTile(
          onTap: onTap,
          leading: Icon(icon,
              color: red ? AppColors.error : AppColors.textPrimary, size: 20),
          title: Text(
            title,
            style: TextStyle(
