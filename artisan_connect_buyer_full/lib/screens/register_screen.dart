...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      ...
      if (!mounted) return;
      ArtisanController().switchRole(user['role'] as String? ?? _role);
      if (_role == 'artisan') {
        ArtisanController().updateArtisanProfile(
          name: _nameController.text.trim(),
          category: _craftController.text.trim(),
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextField(
                  ...
                  labelText: _role == 'artisan'
                      ? 'Artisan / Studio Name'
                      : 'Full Name',
                  hintText: _role == 'artisan'
                      ? 'e.g. Ramesh Handlooms'
                ...
                if (_role == 'artisan') ...[
                  CustomTextField(
                    ...
                    hintText:
                        'e.g. Pottery, Terracotta, Terracotta Lamp, Handloom',
                    prefixIcon: Icons.handyman_outlined,
                    validator: (val) => val == null || val.trim().isEmpty
                        ? 'Please enter your craft'
                        : null,
                  ),
                  const SizedBox(height: 14),
                  CustomTextField(
