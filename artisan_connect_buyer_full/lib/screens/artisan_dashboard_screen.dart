...
class _ArtisanDashboardScreenState extends State<ArtisanDashboardScreen> {
            ...
            children: [
              ...
              if (products.isEmpty)
                EmptyState(
                  ...
                  description:
                      'Start selling by adding your first handcrafted item using AI Smart Cataloging.',
                    ...
                    return ProductCard(
                      ...
                      onEdit: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                AddProductScreen(initialProduct: product),
                          ),
                        );
                      },
  ...
  Future<void> _confirmDelete(BuildContext context, Product product) async {
    ...
    try {
      await _artisanController.deleteProduct(product);
