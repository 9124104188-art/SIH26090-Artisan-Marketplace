  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        final featured = products.where((p) => p.featured).take(8).toList();
            ...
            children: [
                            ...
                            Container(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  Center(
                                    child: Icon(cat.icon, size: 28, color: Colors.white),
                                  ),
                                ],
                              ),
                            ),
              ...
              SectionTitle(
                ...
                onAction: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => CategoryScreen(onProduct: onProduct, cart: cart),
                  ),
                ),
              ),
              const SizedBox(height: 12),
