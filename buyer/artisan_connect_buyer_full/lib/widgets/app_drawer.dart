...
class BuyerDrawer extends StatelessWidget {
              ...
              children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              isArtisan ? 'Artisan Seller Account' : 'Marketplace Buyer Account',
                              style: TextStyle(
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      if (isArtisan) ...[
                        _item(Icons.dashboard_customize_rounded, 'Artisan Dashboard'),
                        _item(Icons.add_circle_outline_rounded, 'Add Product Catalog'),
                        _item(Icons.auto_awesome_rounded, 'AI Smart Cataloging'),
                      ],
                      ...
                      _item(
                        isArtisan ? Icons.swap_horiz_rounded : Icons.handyman_rounded,
                        isArtisan ? 'Switch to Buyer Marketplace' : 'Switch to Artisan Mode',
                      ),
  ...
  Widget _item(IconData icon, String text, {bool red = false}) => ListTile(
        leading: Icon(icon, color: red ? AppColors.error : AppColors.textPrimary, size: 22),
        title: Text(
          text,
          style: TextStyle(
